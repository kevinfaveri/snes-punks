  ...
  return <div className="grid grid-cols-4 gap-4 justify-center items-center h-full">
    <div className="col-span-1">
      {pidNumber !== 0 && <button
        ...
        className="float-right nes-btn is-primary uppercase">Previous Punk</button>}
    </div>
    ...
    <div className="col-span-1">
      {pidNumber !== 9999 && <button
        type="button"
        className="nes-btn is-primary uppercase"
        onClick={() => {
          router.push(`/gallery/${pidNumber + 1}`)
          setIsFirstAccess(false)
        }}>Next Punk</button>}
    ...
    {isFirstAccess && <div
      className="absolute bottom-2 left-2 font-bold text-white text-xs">
